/**
 * Private utility functions used primarily by j1-nbi.js
 */
...
/**
 * Functions to work with j1-nbi status buttons
 * Keep CSS class in sync with j1-nbi/templates/*.tpl
 */
export const statusButtons = (cell = document) =>
  cell.querySelectorAll('.js-j1-nbi-widget')
