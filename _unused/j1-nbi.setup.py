...
setup(
    ...
    url='https://github.com/SamLau95/j1-nbi',
    author='Sam Lau',
    ...
    packages=['j1-nbi'],
    package_data={'j1-nbi': ['templates/*.tpl']},
    ...
    entry_points={
        'nbconvert.exporters': ['interact = j1-nbi:InteractExporter'],
        'console_scripts': ['j1-nbi = j1-nbi.cli:main'],
    }
)
